                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="text" rows="10" style="width:100%" class="form-control" id="text" required>{{ $slider->text }}</textarea>
                                            @if ($errors->has('text'))
                                    ...
                                    <div class="col-md-4">
                                        <img src="{{asset('uploads/images/slider/'.$slider->image)}}" alt="" height="100px" width="100px">
                                    </div>

                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form action="{{ route('admin.photo-gallery.update', $data->id) }}" method="post"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select type="text" name="gallery_cat_id" class="form-control" required>
                                                    @foreach ($galleryCats as $galleryCat)
                                                        <option value="{{ $galleryCat->id }}" @selected($data->id)>{{ $galleryCat->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <img src="{{ asset('uploads/images/gallery/' . $data->image) }}"
                                                    alt="" height="180px">
                                            </div>
                                        </div>
                                        <div class="col-md-6">

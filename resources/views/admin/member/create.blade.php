...
@section('content')
@php $m='member'; $sm='member'; $ssm=''; @endphp
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="name_b" class="form-control" value="{{ old('name_b') }}" id="name_b" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="phone" name="phone" class="form-control" id="phone" value="{{ old('phone') }}" required>
                                                @if ($errors->has('phone'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="school" name="school" class="form-control" id="school" value="{{ old('school') }}" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="profession" class="form-control" id="profession">
                                                    ...
                                                    <option value="{{ $profession->id }}" @selected(old('profession') == $profession) >{{ $profession->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="hobby" name="hobby" class="form-control" id="hobby" value="{{ old('hobby') }}">
                                                @if ($errors->has('hobby'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="pre_address" class="form-control" id="pre_address" value="{{ old('pre_address') }}" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="blood" name="blood" class="form-control" id="blood" value="{{ old('blood') }}">
                                                @if ($errors->has('blood'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="fb" name="fb" class="form-control" id="fb" value="{{ old('fb') }}">
                                                @if ($errors->has('fb'))

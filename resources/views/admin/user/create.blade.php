    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.user.store') }}" method="post"
                onsubmit="ajaxStoreModal(event, this, 'user-add')" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="permission" id="permission" class="form-control">
                                    ...
                                    @foreach (config('var.permissions') as $key => $value)
                            ...
                            <div class="form-group">
                                ...
                                <select name="profession" class="form-control" id="profession">
                                    ...
                                    @foreach ($professions as $profession)
                                        <option value="{{ $profession->id }}" @selected(old('profession') == $profession)>
                                            {{ $profession->name }}
                                        </option>
                                    @endforeach
                                </select>

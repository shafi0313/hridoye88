                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="icon" class="form-control" value="{{ $header->icon }}" placeholder="fa fa-facebook" required>
                                            @if ($errors->has('icon'))
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="content" class="form-control" value="{{ $header->content }}" placeholder="Enter content">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="link" class="form-control" value="{{ $header->link }}" placeholder="Enter link">
                                            @if ($errors->has('link'))

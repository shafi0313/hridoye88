                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <form method="POST" action="{{route('admin.role.permission',$role->id)}}">
                                            ...
                                            @include('roles.permissions.header')
                                            @include('roles.permissions.member')
                                            @include('roles.permissions.menu')
                                            @include('roles.permissions.slider')
                                            @include('roles.permissions.profession')
                                            @include('roles.permissions.gallery_cat')
                                            @include('roles.permissions.photo_gallery')
                                            @include('roles.permissions.video_gallery')
                                            @include('roles.permissions.event')
                                            @include('roles.permissions.message')
                                            @include('roles.permissions.about')
                                            @include('roles.permissions.blog')
